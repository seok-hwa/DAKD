...
from mtdaseg.core.train import train_domain_adaptation
...
def main():
    ...
    if cfg.MODEL.MODEL == 'DeepLabv2':
        model = get_deeplab_v2(num_classes=cfg.DATASETS.NUM_CLASSES, multi_level=cfg.MODEL.MULTI_LEVEL)
    ...
    train_domain_adaptation(model, src_loader, tgt_loader, cfg)
